      ...
      <div className='container mx-auto px-8 md:px-10 py-10'>
        <div className='w-full lg:w-[60vw] mx-auto'>
          ...
          <p className='text-sm text-center mt-4 leading-6'>
            From concept to deployment, these projects showcase my skills in web development,
            design, and problem-solving. Each project reflects my commitment to quality and user experience.
          </p>
        </div>
